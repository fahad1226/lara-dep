<x-app-layout>
    ...
    <div class="px-4 sm:px-6 lg:px-8">
        <div class="sm:flex sm:items-center">
            ...
            <div class="mt-6 sm:ml-16 sm:flex-none">
                <button type="button"
                        ...
                        <table class="min-w-full divide-y divide-gray-300">
                            <thead class="bg-gray-50">
                                <tr>
                                    ...
                                    <th scope="col"
                                        class="px-3 py-3.5 text-left text-sm font-semibold text-gray-900">Compnay</th>
                                    <th scope="col"
                                        class="px-3 py-3.5 text-left text-sm font-semibold text-gray-900">Last Login
                                    </th>
                            ...
                            <tbody class="divide-y divide-gray-200 bg-white">
                                @foreach ($users as $user)
                                    <tr>
                                        ...
                                        {{-- <td class="whitespace-nowrap px-3 py-4 text-sm text-gray-500">
                                            {{ Carbon\Carbon::parse($user->logins->sortBy('login_at')->first()->login_at)->diffForHumans() }}
                                        </td> --}}
